...
//This is where I got the code for this component "https://tailwindcomponents.com/component/sign-up".
        ...
        return (
          <div className=" container w-100 bg">
              <div className="lg:w-2/6 xl:w-2/5 md:w-2/3 bg-gray-100 rounded-lg p-8">
                ...
                <button className="text-white bg-indigo-600 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Sign up</button>
