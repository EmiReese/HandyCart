...
// This is our function that creates the login structure.
    ...
    return (
        <div className="flex items-center min-h-screen bg-white dark:bg-secondary">
            <div className="container mx-auto bg-gray-200">
                <div className="max-w-md mx-auto my-10">
                    <div className="text-center">
                        <h1 className="my-3 text-3xl text-gray-900 dark:text-gray-700">Sign in</h1>
                        ...
                        <div className="m-7">
                            ...
                            <div className="mb-6">
                                <button type="button" className="w-full px-3 py-4 text-white bg-indigo-600 rounded-md focus:bg-indigo-600 focus:outline-none">Sign in</button>
                            </div>
                            <p className="text-sm text-center text-gray-900">Don&#x27;t have an account yet? <a href="#!" className="text-indigo-600 focus:outline-none focus:underline focus:text-indigo-800 dark:focus:border-indigo-600">Sign up</a>.</p>
                    </div>
                </div>
            </div>
        </div>
